...
def prescricao_update():
	...
	try:
		...
		if(int(request.form["flag_prescricao"]) == 1):
			...
			cursor.execute(query, (request.form["num_cedula"],request.form["num_doente"],request.form["data"],request.form["substancia"],request.form["quantidade"]))
		...
		if(int(request.form["flag_prescricao"]) == 2):
			...
			cursor.execute(query, (request.form["quantidade"],request.form["num_cedula"],request.form["num_doente"],request.form["data"],request.form["substancia"]))
		return query
	except Exception as e:
		return str(e) #Renders a page with the error.
	finally:
...
def analise_update():
	...
	try:
		...
		if(int(request.form["flag_analise"]) == 1):
			...
			cursor.execute(query, (request.form["num_analise"],request.form["especialidade"],request.form["num_cedula"],request.form["num_doente"],request.form["data"],request.form["data_registo"],request.form["nome"],request.form["quantidade"],request.form["instituicao"]))
		...
		if(int(request.form["flag_analise"]) == 2):
			...
			cursor.execute(query, (request.form["especialidade"],request.form["num_cedula"],request.form["num_doente"],request.form["data"],request.form["data_registo"],request.form["nome"],request.form["quantidade"],request.form["instituicao"],request.form["num_analise"]))
		return query
	except Exception as e:
		return str(e) #Renders a page with the error.
	finally:
...
def vendas_update():
	...
	try:
		...
		cursor3.execute(query,(num_venda, data_registo, substancia, quant, preco, instituicao))

		if(int(request.form["flag_venda"]) == 1):
			query = f'''INSERT INTO prescricao_venda VALUES (%s,%s,%s,%s,%s);'''
			cursor.execute(query,(num_cedula, num_doente, data, substancia, num_venda))
